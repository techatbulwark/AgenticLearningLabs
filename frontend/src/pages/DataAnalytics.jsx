        ...
        <div className="min-h-screen max-w-[1600px] mx-auto relative overflow-hidden flex flex-col">
            ...
            <section className={`${sectionWrapper} relative bg-white`}>
                <div className="flex flex-col gap-15 items-start my-20 lg:px-inner text-black text-left">
                    ...
                    <div className="flex flex-col gap-5">
                        <h2 className="[font-family:'Unageo-SemiBold'] text-4xl">Modules</h2>
                        <ol className="list-decimal pl-7 text-xl text-left">
                            <li>AI-assisted data narratives and reports</li>
                            <li>AI-augmented analytics</li>
                            <li>Structured data input and data clearing</li>
                            <li>Date visualization and dashboard creation</li>
                            <li>Career Catalyst</li>
                        </ol>
                    </div>
                    <div className="flex flex-col gap-5">
                        <h2 className="[font-family:'Unageo-SemiBold'] text-4xl">Format</h2>
                        <div className="flex flex-col gap-5">
                            <p className="text-xl">This is a 4-week hybrid course that goes beyond theory to provide you with practical hands-on experience.</p>
                            <p className="[font-family:'Unageo-Bold'] text-2xl">Weeks 1-3: Online + in-person learning</p>
                            ...
                            <p className="[font-family:'Unageo-Bold'] text-2xl">Week 4: Final in-person workshop + Career Catalyst (one day)</p>
                    ...
                    <div className="flex flex-col gap-5">
                        ...
                        <ul className="list-disc pl-7 text-xl text-left">
                            ...
                            <li>No AI experience required, just curiosity and commitment.</li>
                        </ul>
                    </div>
                </div>
            </section>
