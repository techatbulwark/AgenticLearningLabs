...
const SDFAllCohortsForm = () => {
    ...
    const initialData = {};
      ...
      Object.values(FORM_CONFIG).forEach(section => {
        section.fields.forEach(field => {
          if (field.id === "cohort") {
            initialData[field.id] = meta.cohort;
          } else if (field.id === "courseType") {
            initialData[field.id] = meta.courseType;
          } else if (field.id === "startMonth") {
            initialData[field.id] = meta.startMonth;
          } else if (field.id === "sdfLink") {
            initialData[field.id] = sdfLinkValue;
  ...
  const handleSampleData = () => {
    const sampleData = {
      ...
      altPhone: '',
      altPhoneNum: '',
      email: 'test+2@bulwarkimpact.org',

      // Profile Information
      labourForce: 'employed',
      sourceIncome: 'employed_with_employer',
      sinNum: '123456789',
      desgGroup: 'none',
      ...
      // Employment
      empType: 'paid',
      empName: 'Test Company Inc.',
      jobTitle: 'Software Developer',
      empStartDate: '2020-01-01',
      empEndDate: '',
      empCurrentlyEmployed: true,
      empCountry: 'Canada',
      prefWageMethod: 'hourly',
      wageAmount: '50000',
      hourlyWage: '25.00',
      paidHoursWeek: '40',
      reasonLeaving: '',
      ...
      additionalEmpName: '',
      additionalJobTitle: '',
      additionalEmpStartDate: '',
      additionalEmpEndDate: '',
      additionalCurrentlyEmployed: false,
      additionalEmpCountry: '',
      additionalPrefWageMethod: '',
      additionalWageAmount: '',
      additionalHourlyWage: '',
      additionalPaidHoursWeek: '',
      additionalReasonLeaving: '',
      noc: '2174',
      naics: '5415',

      // Signatures
      serviceAcknowledge: true,
      serviceParticipantName: 'Test User',
      serviceParticipantDate: new Date().toISOString().split('T')[0],
      serviceGuardianName: '',
      serviceGuardianDate: '',
      ministryAcknowledge: true,
      ministryParticipantName: 'Test User',
      ministryParticipantDate: new Date().toISOString().split('T')[0],
      ministryGuardianName: '',
      ministryGuardianDate: '',
    };

    setFormData(sampleData);
    alert('Sample data has been populated!');
  };
    ...
    <div className="min-h-screen relative overflow-hidden flex flex-col bg-white">
      <div className="max-w-6xl mx-auto my-20 px-10 bg-card">
        ...
        <form onSubmit={handleSubmit} className="space-y-8 text-black">
          ...
          <div className="flex flex-col lg:flex-row gap-4 items-center lg:items-end lg:justify-end">
            <button
              type="button"
              onClick={handleReset}
...
export default SDFAllCohortsForm;
