        ...
        <div className="fixed inset-0 flex items-center justify-center backdrop-blur-sm z-50">
            <div className="relative max-w-lg max-h-[90vh] bg-white rounded-2xl py-25 px-15">
                <div className="flex flex-col gap-y-10 items-center">
                    ...
                    <p className="[font-family:'Unageo'] text-xl text-black text-center">We will reach out to you shortly. Please watch for an email from <b className="[font-family:'Unageo-Bold']">info@agenticlearninglabs.com.</b></p>
                </div>
            </div>
        </div>
    )
